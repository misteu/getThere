...
public struct SearchTextFieldTheme {
  ...
  public static func customTheme() -> SearchTextFieldTheme {
    return SearchTextFieldTheme(cellHeight: 30, bgColor: UIColor (red: 0.8, green: 0.8, blue: 0.8, alpha: 0.8), borderColor: UIColor (red: 0.7, green: 0.7, blue: 0.7, alpha: 1.0), separatorColor: UIColor.clear, font: UIFont.systemFont(ofSize: 20), fontColor: UIColor.black)
  }
}
