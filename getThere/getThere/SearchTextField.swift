...
open class SearchTextField: UITextField {
  ...
  open var theme = SearchTextFieldTheme.customTheme() {
    didSet {
  ...
  open var highlightAttributes: [NSAttributedString.Key: AnyObject] = [.font: UIFont.boldSystemFont(ofSize: 18), NSAttributedString.Key.foregroundColor: UIColor.black]
...
public struct SearchTextFieldTheme {
  ...
  public static func customTheme() -> SearchTextFieldTheme {
    return SearchTextFieldTheme(cellHeight: 30, bgColor: UIColor (red: 0.8, green: 0.8, blue: 0.8, alpha: 0.6), borderColor: UIColor (red: 0.7, green: 0.7, blue: 0.7, alpha: 1.0), separatorColor: UIColor.clear, font: UIFont.systemFont(ofSize: 20), fontColor: UIColor.black)
  }
}
